 ...
 */
final class Version20260325002009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, text_content VARCHAR(510) NOT NULL, created_at DATETIME NOT NULL, media_url VARCHAR(255) DEFAULT NULL, author_id INT NOT NULL, INDEX IDX_5A8A6C8DF675F31B (author_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(22) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(500) NOT NULL, profile_picture VARCHAR(500) DEFAULT NULL, bio VARCHAR(500) DEFAULT NULL, location VARCHAR(100) DEFAULT NULL, roles JSON NOT NULL, is_blocked TINYINT NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
